...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.PatientLabel.setGeometry(QtCore.QRect(10, 0, 251, 20))
        font = QtGui.QFont()
        ...
        self.ButtonRemoveFilter.setGeometry(QtCore.QRect(380, 770, 51, 51))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(False)
        ...
        self.ComboFilterType.setGeometry(QtCore.QRect(10, 770, 111, 51))
        font = QtGui.QFont()
        font.setPointSize(23)
        font.setItalic(True)
        ...
        self.ComboFilterType.addItem("")
        self.ComboFilterType.addItem("")
        self.SpinBandWidth = QtWidgets.QSpinBox(self.WidgetFilter)
        self.SpinBandWidth.setGeometry(QtCore.QRect(140, 770, 111, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setItalic(True)
        self.SpinBandWidth.setFont(font)
        self.SpinBandWidth.setMinimum(1)
        self.SpinBandWidth.setMaximum(6000)
        self.SpinBandWidth.setSingleStep(10)
        self.SpinBandWidth.setProperty("value", 100)
        ...
        self.ButtonFFT.setCheckable(True)
        ...
        self.PatientLabel_10.setGeometry(QtCore.QRect(380, 790, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.PatientLabel_11.setGeometry(QtCore.QRect(550, 790, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.PatientLabel_12.setGeometry(QtCore.QRect(750, 790, 241, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.PatientLabel_13.setGeometry(QtCore.QRect(20, 790, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1892, 27))
    ...
    def actions(self):
        ...
        if self.ComboFilterType.currentText()=='Auto': self.ButtonAddFilter.hide()
    ...
    def update_widget_size(self,flag):
        if flag:
            ...
            self.PlotTemporalWidget_2.setGeometry(QtCore.QRect(300, 110, 1481+30, 831))
            self.PlotTemporalWidget.setGeometry(QtCore.QRect(10, 10, 1451+30, 751))
    ...
    def update_filter_Plot(self,sc=None, bandwidth=None):
        ...
        self.PlotSpectralWidget.setYRange(0, 2000, padding=0)
    ...
    def update_tf_plot(self):
        ...
        tfplt = pg.plot(self.ffrjson.t*1000,self.DeltaPhase ,pen=pg.mkPen('b', width=1))
        tfplt = pg.plot(self.ffrjson.t*1000,self.current_waveform/np.max(self.current_waveform),pen=pg.mkPen('g', width=1))
        tfplt = pg.plot(self.ffrjson.t*1000,self.current_waveform/np.max(self.current_waveform),pen=pg.mkPen('g', width=1))
        tfplt.showGrid(x=True,y=True)
    ...
    def add_to_workspace(self,waveforms,label):
        return None

    def remove_from_workspace(self,label):
        return None
